...
<div class="box-container">
   ...
   ?>
   <div class="box">
   <p> id : <span><?= $fetch_message['id_client']; ?></span></p>
   <p> Nom : <span><?= $fetch_message['name']; ?></span></p>
   <p> Email : <span><?= $fetch_message['email']; ?></span></p>
   <p> Numero : <span><?= $fetch_message['number']; ?></span></p>
   <p> Message : <span><?= $fetch_message['message']; ?></span></p>
   <a href="messages.php?delete=<?= $fetch_message['id']; ?>" onclick="return confirm('Voulez-vous supprimer ce message ?');" class="delete-btn">Supprimer</a>
   </div>
   <?php
         }
      }else{
