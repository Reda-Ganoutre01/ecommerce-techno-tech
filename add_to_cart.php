...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(isset($_SESSION['id_client'])) {
        ...
        $stmt = $conn->prepare("INSERT INTO cart (id_client, id_produit, nom_produit, prix_produit, image, quantity) VALUES (?, ?, ?, ?, ?, ?)");
        ...
        $bind_result = $stmt->bind_param("iisdsi", $id_client, $id_produit, $nom_produit, $prix_produit, $image, $quantity);
