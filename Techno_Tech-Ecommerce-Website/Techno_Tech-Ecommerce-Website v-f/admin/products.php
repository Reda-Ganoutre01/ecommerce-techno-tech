...
//    $select_products = $pdo->prepare("SELECT * FROM `produits` WHERE name = ?");
...
//       $insert_products = $pdo->prepare("INSERT INTO `products`(name, details, price, image_01, image_02, image_03) VALUES(?,?,?,?,?,?)");
...
//    $delete_product_image = $pdo->prepare("SELECT * FROM `products` WHERE id = ?");
...
<section class="show-products">
   ...
   <div class="box">
      ...
      <div class="price">Nrs.<span><?= htmlspecialchars($fetch_products['prix']); ?></span>/-</div>
